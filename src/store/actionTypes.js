...
export const ADD_TRANSPARENT_STICKER = "ADD_TRANSPARENT_STICKER";
export const DELETE_TRANSPARENT_STICKER = "DELETE_TRANSPARENT_STICKER";

export const SHOW_DELETE_ZONE = "SHOW_DELETE_ZONE";
export const HIDE_DELETE_ZONE = "HIDE_DELETE_ZONE";